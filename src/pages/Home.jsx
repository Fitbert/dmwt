...
const STEPS = [
  {
    ...
    body: "Type your address or upload your appraisal notice. We pull county records automatically — no digging required.",
    note: "All 254 Texas counties",
  },
  {
    num: "02",
    title: "We build the case",
    body: "Comparable sales, equity analysis, condition notes — assembled into a clean, ARB-ready packet built for your county.",
    note: "Both arguments included",
  },
  {
    num: "03",
    title: "You file, you fight",
    body: "Download your complete PDF protest packet, formatted for your county's ARB. Hearing prep with talking points available too.",
    note: "Ready in under 24 - 48 hours",
  },
];
...
const TIERS = [
  {
    ...
    items: [
      ...
      "Equity / uniformity analysis (§42.26)",
...
export default function Home() {
  ...
  return (
    <div
      style={{ background: C.cream, fontFamily: "'Special Elite', monospace" }}
    >
      <style>{`
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              No attorney. No confusing forms. A complete protest packet built
              from public records.
            </p>
          </motion.div>
              ...
              >
                ...
                <div
                  style={{
                    fontSize: 10.5,
                    color: C.rust,
                    borderTop: "1px dashed rgba(60,30,8,0.18)",
                    paddingTop: 10,
      ...
      <div
        style={{
          background: C.brown,
          padding: `24px ${px}`,
          borderTop: "2px solid #1c1008",
          borderBottom: "2px solid #1c1008",
        }}
      >
        <div className="stats-row" style={{ maxWidth: 1200, margin: "0 auto" }}>
          {[
            { val: "$1,240", label: "Avg. annual savings" },
            { val: "73%", label: "Win a reduction" },
            { val: "254", label: "Texas counties" },
            { val: "May 15", label: "Protest deadline" },
          ].map(({ val, label }) => (
            <div
              key={label}
              style={{
                textAlign: "center",
                padding: isMobile ? "4px 0" : "0 24px",
              }}
            >
              <div
                style={{
      ...
      <div
        style={{
          background: C.tan,
          padding: `${isMobile ? "36px" : "48px"} ${px}`,
          borderBottom: "1px solid rgba(60,30,8,0.15)",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <div>
            ...
            >
              "Saved $1,800 on my Travis County taxes last year. Took me less
              time than making a pot of coffee — and I drink a lot of coffee."
            </p>
            <p
              style={{
                fontFamily: "'Special Elite', monospace",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Pay once, get a professional packet. Save even one month of taxes
              and you've already broken even.
            </p>
          </motion.div>
            ...
            {TIERS.map(({ name, price, desc, items, highlight, cta }, i) => (
              <motion.div
                ...
                style={{
                  ...
                  background: highlight ? C.brown : C.cream,
                  position: "relative",
                }}
              >
                {highlight && (
                ...
                >
                  ...
                  <span
                    style={{
                      fontFamily: "'Special Elite', monospace",
                      fontSize: 11,
                      color: highlight ? "rgba(232,220,200,0.5)" : C.faded,
                    }}
                  >
                    / property
                  </span>
                ...
                <p
                  style={{
                    ...
                    fontStyle: "italic",
                    fontSize: 13,
                    color: highlight ? "rgba(232,220,200,0.6)" : C.faded,
                    marginBottom: 22,
                  }}
                >
                  {desc}
                  ...
                  {items.map((item) => (
                    <li
                      ...
                      style={{
                        ...
                        fontFamily: "'Special Elite', monospace",
                        fontSize: 12,
                        color: highlight ? "rgba(232,220,200,0.8)" : C.ink,
                      }}
                    >
                ...
                <Link
                  ...
                  style={{
                    ...
                    padding: "13px 24px",
                    textDecoration: "none",
                    background: highlight ? C.rust : "transparent",
                    color: highlight ? C.cream : C.rust,
